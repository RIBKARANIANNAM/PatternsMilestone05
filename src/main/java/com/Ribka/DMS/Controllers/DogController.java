package com.Ribka.DMS.Controllers;
...
import com.Ribka.DMS.Models.Trainer;
import com.Ribka.DMS.repository.DogRepository;
import com.Ribka.DMS.repository.TrainerRepository;
...
public class DogController {
	...
	public ModelAndView editDog(Dog dog) {
	  ...
	  Dog d = dogRepo.findById(dog.getId()).orElse(new Dog()); dogRepo.delete(d);
	  return home(); 
	  }
